...
public class ChangeTextBehaviorTest {
    ...
    @Test
    public void checkTitleAndTextInput()
    {   String identifierByText="Basic Espresso sample";
        onView(withText(identifierByText)).check(matches(isDisplayed()));
        onView(withId(R.id.editTextUserInput)).perform(click()).perform(typeTextIntoFocusedView("bill"));
        onView(withText(identifierByText)).check(matches(isDisplayed()));
